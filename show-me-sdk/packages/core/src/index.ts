...
export { DOMScanner, ScannedElement } from './scanner/DOMScanner';
export { CursorEngine, CursorConfig } from './cursor/CursorEngine';
export { Easing } from './animation/easing';
export { AgentClient, QueryRequest, QueryResponse } from './client/AgentClient';
...
export interface ShowMeConfig {
  ...
  cursorStyle?: {
    size?: number;
    color?: string;
    animation?: 'easeOutCubic' | 'linear' | 'easeOutElastic' | 'easeOutBack';
  };
  debug?: boolean;
}
